...
| Capability | Active full-chain direct: **29/30 = 96.7%**, Wilson 95% CI **83.3–99.4%**. Passive: **0/30**, CI **0–11.4%**. Paired gain: **+96.7 percentage points**; exact two-sided McNemar **p = 3.73×10⁻⁹**. “Full-chain” requires mission success, direct/no-detour, and a Python+Go+effective joint admit for the corridor actually executed. | [challenge report](../release/v8-frozen/results/challenge_102500_102529/CHALLENGE_REPORT.json) |
