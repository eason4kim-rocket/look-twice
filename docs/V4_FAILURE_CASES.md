...
| --- | --- | --- |
| Unsafe crossing | risk entry, truth, gate, trajectory/contact | **0** in archived smoke 96; formal partial N=36 also **0** unsafe (incomplete matrix) |
...
| Packaged on Mac/GitHub (this sync) | **36** completed raw + **1** error JSON |
