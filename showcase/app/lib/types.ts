...
export type EpisodeBundle = {
  ...
  gate_receipts:GateReceipt[]; repair_requests:Array<Record<string,unknown>>; nbv_candidates:Array<Record<string,unknown>>; motion_segments:Array<Record<string,unknown>>;
  events:Array<{event_id:string;step:number;type:string;status:string;title_key:string;ref_id:string}>;
